...
export class ReplaceAspectNamesByI18nKeys1616588129420
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await this.replaceAspectNamesByI18Keys(
      'v5:compact',
      'Compact',
      queryRunner
    );
  ...
  private async replaceAspectNamesByI18Keys(
    i18nPrefix: string,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    const shortNameToOldNameCompact = new Map<string, string>([
      ...
      [
        'A1.2',
        'Negative aspect: violation of human dignity in the supply chain',
      ],
      ...
      [
        'A3.2',
        'Negative aspect: disproportionate environmental impact throughout the supply chain',
      ],
      ...
      [
        'C3.2',
        'Negative aspect: guidance on waste/ environmentally damaging practices',
      ],
      ...
      [
        'D2.2',
        'Negative aspect: abuse of market power to the detriment of other companies',
      ],
      [
        'D3.1',
      ...
      [
        'D3.2',
        'Negative aspect: wilful disregard of disproportionate environmental impacts',
      ],
      ...
      [
        'E3.2',
        'Negative aspect: infringement of environmental regulations and disproportionate environmental pollution',
      ],
      ['E4.1', 'Social co-determination and transparency'],
      [
        'E4.2',
        'Negative aspect: lack of transparency and wilful misinformation',
      ],
    ]);
    ...
    const shortNameToOldNameFull = new Map<string, string>([
      ...
      [
        'A2.2',
        'Exercising a positive influence on solidarity and social justice in the supply chain',
      ],
      ...
      [
        'A4.1',
        'Transparency towards suppliers and their right to co-determination',
      ],
      [
        'A4.2',
        'Positive influence on transparency and co-determination throughout the supply chain',
      ],
      ...
      [
        'C3.3',
        'Organisational culture, cultivating awareness for an environmentally-friendly approach',
      ],
      [
        'C3.4',
        'Negative aspect: guidance on waste/ environmentally damaging practices',
      ...
      [
        'D3.1',
        'Environmental cost-benefit ration of products and services (efficiency and consistency) ',
      ],
      ...
      [
        'D4.1',
        'Customer participation, joint product development and market research',
      ],
      ['D4.2', 'Product transparency'],
      ['D4.3', 'Negative aspect: non-disclosure of hazardous substances'],
      [
        'E1.1',
        'Products and services should cover basic needs and contribute to a good life',
      ],
