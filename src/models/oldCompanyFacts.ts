...
export type OldCompanyFacts = z.infer<typeof CompanyFactsSchema>;
 ...
 */
export function allValuesAreZero(companyFacts: OldCompanyFacts): boolean {
  if (
    [
...
export function companyFactsToResponse(companyFacts: OldCompanyFacts) {
  return {
    ...companyFacts,
