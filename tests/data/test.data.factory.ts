...
export class TestDataFactory {
    ...
    public static createTopics(): Topic[] {
        ...
        const threeAspectDefautlMaxPoints = 17.094017094017094;
        const defaultEstimations = 0;
        const defaultPoints = defaultEstimations;
        const defaultWeight = 1;
        const defaultWeightA4 = 0.5;
        return [
            new Topic(undefined, "A1", "A1 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
            ...
            new Topic(undefined, "B1", "B1 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
                [
                    new PositiveAspect(undefined, 'B1.1', 'B1.1 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'B1.2', 'B1.2 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'B1.3', 'B1.3 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1)
                ],
                []
            ),
            ...
            new Topic(undefined, "C1", "C1 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
                [
                    new PositiveAspect(undefined, 'C1.1', 'C1.1 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C1.2', 'C1.2 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C1.3', 'C1.3 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                ],
            ...
            new Topic(undefined, "C2", "C2 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
                [
                    new PositiveAspect(undefined, 'C2.1', 'C1.1 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C2.2', 'C2.2 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C2.3', 'C2.3 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                ],
            ...
            new Topic(undefined, "C3", "C3 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
                [
                    new PositiveAspect(undefined, 'C3.1', 'C3.1 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C3.2', 'C3.2 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C3.3', 'C3.3 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                ],
            ...
            new Topic(undefined, "C4", "C4 name", defaultEstimations, defaultPoints, topicDefaultMaxPoints, defaultWeight,
                [
                    new PositiveAspect(undefined, 'C4.1', 'C4.1 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C4.2', 'C4.2 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                    new PositiveAspect(undefined, 'C4.3', 'C4.3 name', defaultEstimations, defaultPoints, threeAspectDefautlMaxPoints, 1),
                ],
