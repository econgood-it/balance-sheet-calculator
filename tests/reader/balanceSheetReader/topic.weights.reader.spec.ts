...
describe('Topic weights reader', () => {
  it('should read topic weights from excel', async () => {
    ...
    expect(topicWeights?.get('E4')).toBe(0.5);
  });
});
